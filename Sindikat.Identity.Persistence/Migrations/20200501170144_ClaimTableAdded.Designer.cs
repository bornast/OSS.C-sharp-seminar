...
namespace Sindikat.Identity.Persistence.Migrations
{
    ...
    [Migration("20200501170144_ClaimTableAdded")]
    partial class ClaimTableAdded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sindikat.Identity.Domain.Entities.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("Sindikat.Identity.Domain.Entities.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Sindikat.Identity.Domain.Entities.UserRole", b =>
                {
                    b.HasOne("Sindikat.Identity.Domain.Entities.Role", "Role")
                        .WithMany("UserRoles")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
